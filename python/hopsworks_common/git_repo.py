...
class GitRepo:
    ...
    def status(self):
        ...
        # Returns
            `List[GitFileStatus]`
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to retrieve the status.
        """
    ...
    def checkout_branch(self, branch: str, create: bool = False):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to checkout the branch.
        """
        if create:
    ...
    def checkout_commit(self, commit: str):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to checkout the commit.
        """
    ...
    def checkout_files(self, files: Union[List[str], List[GitFileStatus]]):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to checkout the files.
        """
    ...
    def delete_branch(self, branch: str):
        ...
        # Arguments
            branch: name of the branch
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to delete the branch.
        """
    ...
    def commit(self, message: str, all: bool = True, files: List[str] = None):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to perform the commit.
        """
    ...
    def push(self, branch: str, remote: str = "origin"):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to push.
        """
    ...
    def pull(self, branch: str, remote: str = "origin"):
        ...
        # Arguments
            ...
            remote: name of the remote
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to pull.
        """
    ...
    def get_commits(self, branch: str):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to retrieve the commits.
        """
    ...
    def add_remote(self, name: str, url: str):
        ...
        # Returns
            `GitRemote`
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to add the remote.
        """
    ...
    def get_remote(self, name: str):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to get the remote.
        """
    ...
    def get_remotes(self):
        ...
        # Returns
            `List[GitRemote]`
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to retrieve the remotes.
        """
