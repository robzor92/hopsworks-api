...
class VariableApi:
    def get_variable(self, variable: str):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to get the variable
        """
    ...
    def get_version(self, software: str) -> Optional[str]:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to get the version
        """
    ...
    def get_data_science_profile_enabled(self) -> bool:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to obtain the flag's value.
        """
    ...
    def get_loadbalancer_external_domain(self, service: str) -> str:
        ...
        # Raises
            ...
            `hopsworks.client.exceptions.RestAPIError`: Other errors than variable not found.
        """
        try:
