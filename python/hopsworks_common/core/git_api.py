...
class GitApi:
    ...
    def clone(self, url: str, path: str, provider: str = None, branch: str = None) -> git_repo.GitRepo:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to clone the git repository.
        """
    ...
    def get_repos(self) -> List[git_repo.GitRepo]:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to get the repositories
        """
        _client = client.get_instance()
        path_params = [
            "project",
    ...
    def get_providers(self) -> List[git_provider.GitProvider]:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to get the git providers
        """
    ...
    def get_provider(self, provider: str) -> git_provider.GitProvider:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to get the git provider
        """
    ...
    def set_provider(self, provider: str, username: str, token: str):
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to configure the git provider
        """
    ...
    def get_repo(self, name: str, path: str = None) -> git_repo.GitRepo:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to get the git repo
        """
        _client = client.get_instance()
        path_params = [
            "project",
