...
setup(
    ...
    version=__version__,
    install_requires=[
        "hsfs @ git+https://git@github.com/robzor92/feature-store-api@HWORKS-798#egg=hsfs[python]&subdirectory=python",
        "hsml @ git+https://git@github.com/robzor92/machine-learning-api@HWORKS-798-new#egg=hsml&subdirectory=python",
        "pyhumps==1.6.1",
        "requests",
        "furl",
        "boto3",
