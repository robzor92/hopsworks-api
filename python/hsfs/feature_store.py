...
class FeatureStore:
    ...
    def get_feature_group(
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If encountering an error while trying to retrieve the feature group
        """
        if version is None:
            warnings.warn(
    ...
    def get_feature_groups(
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to retrieve feature group from the feature store.
        """
    ...
    def get_training_dataset(
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to retrieve training dataset from the feature store.
        """
    ...
    def get_feature_view(
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If encountering an error while trying to retrieve the feature view
        """
        if version is None:
            warnings.warn(
    ...
    def get_feature_views(self, name: str) -> List[feature_view.FeatureView]:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: If unable to retrieve feature view from the feature store.
        """
