...
class FeatureView:
    ...
    def get_training_datasets(self) -> List["training_dataset.TrainingDatasetBase"]:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to retrieve the training datasets metadata.
        """
    ...
    def purge_training_data(self, training_dataset_version: int) -> None:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to delete the training dataset.
        """
    ...
    def purge_all_training_data(self) -> None:
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: in case the backend fails to delete the training datasets.
        """
        if self._last_accessed_training_dataset is not None:
            self.update_last_accessed_training_dataset(None)
    ...
    def get_feature_monitoring_configs(
        ...
        # Raises
            `hopsworks.client.exceptions.RestAPIError`: In case the backend encounters an issue
            `hopsworks.client.exceptions.FeatureStoreException`: FIX ME
